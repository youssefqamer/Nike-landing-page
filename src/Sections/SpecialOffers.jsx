...
const SpecialOffers = () => {
  return (
    <section className="flex flex-wrap justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
    ...
    <p className="mt-4 lg:max-w-lg info-text">Embark on a shopping journey that redefines your experience with
        ...
        <div className="mt-11 flex flex-wrap gap-4 ">
          ...
          <Button label='Lear more' backgroundColor='bg-white' borderColor='border-slate-gray textColor="text-slate-gray" '/>
